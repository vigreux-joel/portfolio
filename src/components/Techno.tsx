    ...
    return (
        ...
        >
            {(image || icon) && <div
                ...
                {image && <div dangerouslySetInnerHTML={{__html: image}} className={classNames({
            ...
            <div className={"flex-1 flex flex-col justify-between items-start"}>
                <div>
                    ...
                    <div className={"relative"}>
                        <div
                            className={classNames("transition-all duration-300 delay-200 text-on-surface-variant max-w-prose", {
