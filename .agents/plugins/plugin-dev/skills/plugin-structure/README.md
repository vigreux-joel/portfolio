...
Comprehensive guidance on Antigravity plugin architecture, directory layout, and best practices.
...
- Portable path references with `${ANTIGRAVITY_PLUGIN_ROOT}`
...
- Ask about "${ANTIGRAVITY_PLUGIN_ROOT}" usage
...
Antigravity loads references and examples only as needed based on the task.
