...
3. Check adherence to project best practices and coding standards from CONTEXT.md
...
5. **Best Practices**:
   - Follow project-specific standards from CONTEXT.md
...
- Missing context (no CONTEXT.md): Apply general best practices
