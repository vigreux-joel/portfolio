...
Use this template to generate agents using Antigravity with the agent creation system prompt.
...
Send this to Antigravity (with the agent-creation-system-prompt loaded):
...
### Step 3: Antigravity Returns JSON

Antigravity will return:
...
Tell Antigravity when the agent should activate:
...
- **Comprehensive**: Antigravity includes edge cases and quality checks
