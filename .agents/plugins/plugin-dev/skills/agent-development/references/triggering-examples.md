...
assistant: "[How Antigravity should respond before triggering]"
<commentary>
[Explanation of why this agent should be triggered in this scenario]
</commentary>
assistant: "[How Antigravity triggers the agent - usually 'I'll use the [agent-name] agent...']"
</example>
```
...
**Purpose:** Show what Antigravity says before launching the agent
...
**Purpose:** Show how Antigravity invokes the agent
...
- Show Antigravity using Agent tool
