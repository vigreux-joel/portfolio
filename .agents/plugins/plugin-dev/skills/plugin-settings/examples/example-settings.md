...
**.agents/experimental-features.local.md:**
...
# Read settings
FRONTMATTER=$(sed -n '/^---$/,/^---$/{ /^---$/d; p; }' ".agents/my-plugin.local.md")
...
```bash
# Edit settings
vim .agents/my-plugin.local.md

# Changes take effect after restart
exit  # Exit Antigravity
antigravity  # Restart
```

Changes require Antigravity restart - hooks can't be hot-swapped.
