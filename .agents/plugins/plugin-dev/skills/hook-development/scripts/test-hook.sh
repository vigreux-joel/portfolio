...
# Set up environment
export ANTIGRAVITY_PROJECT_DIR="${ANTIGRAVITY_PROJECT_DIR:-/tmp/test-project}"
export ANTIGRAVITY_PLUGIN_ROOT="${ANTIGRAVITY_PLUGIN_ROOT:-$(pwd)}"
export ANTIGRAVITY_ENV_FILE="${ANTIGRAVITY_ENV_FILE:-/tmp/test-env-$$}"

if [ "$VERBOSE" = true ]; then
  echo "Environment:"
  echo "  ANTIGRAVITY_PROJECT_DIR=$ANTIGRAVITY_PROJECT_DIR"
  echo "  ANTIGRAVITY_PLUGIN_ROOT=$ANTIGRAVITY_PLUGIN_ROOT"
  echo "  ANTIGRAVITY_ENV_FILE=$ANTIGRAVITY_ENV_FILE"
  echo ""
fi
...
if [ -f "$ANTIGRAVITY_ENV_FILE" ]; then
  echo ""
  echo "Environment file created:"
  cat "$ANTIGRAVITY_ENV_FILE"
  rm -f "$ANTIGRAVITY_ENV_FILE"
fi
