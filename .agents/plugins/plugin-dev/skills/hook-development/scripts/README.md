...
Tests individual hook scripts with sample input before deploying to Antigravity.
...
**Features:**
- Sets up proper environment variables (ANTIGRAVITY_PROJECT_DIR, ANTIGRAVITY_PLUGIN_ROOT)
...
- Path in hooks.json is correct (use `${ANTIGRAVITY_PLUGIN_ROOT}`)
