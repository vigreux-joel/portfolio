...
**Important:** All examples below are written as instructions FOR Antigravity (agent consumption), not messages TO users. Commands tell Antigravity what to do, not tell users what will happen.

## Example 1: Code Review Command

**File:** `.agents/commands/review.md`
...
**File:** `.agents/commands/test-file.md`
...
**File:** `.agents/commands/document.md`
...
**File:** `.agents/commands/git-status.md`
...
**File:** `.agents/commands/compare-files.md`
...
**File:** `.agents/commands/quick-fix.md`
...
**File:** `.agents/commands/research.md`
...
**File:** `.agents/commands/explain.md`
