...
```markdown
.agents/plugin-name-workflow.local.md:
...
Reading workflow state from .agents/plugin-name-workflow.local.md...

Current stage: @.agents/plugin-name-workflow.local.md
...
State file: @.agents/plugin-name-workflow.local.md
