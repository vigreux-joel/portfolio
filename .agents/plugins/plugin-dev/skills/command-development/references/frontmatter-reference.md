...
**Purpose:** Specify which Antigravity model executes the command
...
- Antigravity can invoke programmatically
...
**Best practices:**
- Use sparingly (limits Antigravity's autonomy)
...
**Invalid model name:**
```yaml
model: gpt4  # ❌ Not a valid Antigravity model
```
