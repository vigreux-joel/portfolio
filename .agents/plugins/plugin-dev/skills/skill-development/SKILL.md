...
description: This skill should be used when the user wants to "create a skill", "add a skill to plugin", "write a new skill", "improve skill description", "organize skill content", or needs guidance on skill structure, progressive disclosure, or skill development best practices for Antigravity plugins.
version: 0.1.0
---

# Skill Development for Antigravity Plugins

This skill provides guidance for creating effective skills for Antigravity plugins.
...
**For Antigravity plugins:** When building a hooks skill, the analysis shows:
...
For Antigravity plugins, create the skill directory structure:
...
When editing the (newly-created or existing) skill, remember that the skill is being created for another instance of Antigravity to use. Focus on including information that would be beneficial and non-obvious to Antigravity. Consider what procedural knowledge, domain-specific details, or reusable assets would help another Antigravity instance execute these tasks more effectively.
...
Antigravity automatically discovers skills:
...
- References include the AI generation prompt from Antigravity
...
Antigravity should extract fields...
...
**Why bad:** Antigravity doesn't know references exist
...
**Why good:** Antigravity knows where to find additional information
