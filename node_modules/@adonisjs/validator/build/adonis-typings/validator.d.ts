...
declare module '@ioc:Adonis/Core/Validator' {
     ...
     */
    export type DurationUnits = keyof DurationObjectUnits | 'year' | 'quarter' | 'month' | 'week' | 'day' | 'hour' | 'minute' | 'second' | 'millisecond';
    /**
     * Helper
     */
    ...
    export interface EnumType {
        ...
        nullable<Options extends AllowedEnumOptions>(options: Options, rules?: Rule[]): {
            t: EnumReturnValue<Options> | null;
            getTree(): SchemaLiteral;
        };
        nullableAndOptional<Options extends AllowedEnumOptions>(options: Options, rules?: Rule[]): {
            t?: EnumReturnValue<Options> | null;
            getTree(): SchemaLiteral;
        };
    }
    ...
    export interface FileType {
        ...
        nullable(options?: Partial<FileValidationOptions>, rules?: Rule[]): {
            t: MultipartFileContract | null;
            getTree(): SchemaLiteral;
        };
        nullableAndOptional(options?: Partial<FileValidationOptions>, rules?: Rule[]): {
            t?: MultipartFileContract | null;
            getTree(): SchemaLiteral;
        };
    }
